...
pub fn load_pkcs12(data: &[u8], password: &str) -> Result<Key, Error> {
    let contents = ribergshamra_pkcs12::parse_pkcs12(data, password)?;
...
pub fn try_load_pq_private_key(der: &[u8]) -> Option<Key> {
    ...
    use ribergshamra_crypto::sign::PqAlgorithm;
...
mod tests {
    ...
    fn test_ed25519_roundtrip_pkcs8_sign_verify() {
        ...
        let algo = ribergshamra_crypto::sign::from_uri_with_context(
            ribergshamra_core::algorithm::EDDSA_ED25519,
            None,
        )
