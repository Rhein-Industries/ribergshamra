...
//! Error and result types shared by ribergshamra crates.

/// Errors produced by the ribergshamra XML Security library.
...
pub enum Error {
    ...
    /// The document or caller requested an algorithm URI that ribergshamra does
