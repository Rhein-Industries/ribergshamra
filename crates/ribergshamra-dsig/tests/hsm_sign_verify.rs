...
//!
//! Prerequisites: run `bash hsm-test/setup.sh` from the ribergshamra root directory.
//! Tests are ignored by default; run with:
//!     cargo test -p ribergshamra-dsig --test hsm_sign_verify -- --ignored
...
#[test]
#[ignore] // Requires SoftHSM2 setup + riptering PKCS#11 signing + ribergshamra-dsig HSM integration
...
<Root>
  ...
  <ds:Signature xmlns:ds="http://www.w3.org/2000/09/xmldsig#">
    ...
    let signed_info_c14n = {
        ...
        let no_prefixes: &[&str] = &[];
        ribergshamra_c14n::canonicalize_doc(&doc, C14nMode::Exclusive, Some(&ns), no_prefixes)
...
#[test]
#[ignore] // Requires SoftHSM2 setup + riptering PKCS#11 signing + ribergshamra-dsig
